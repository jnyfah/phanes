...
// Scalar
static auto rotate_left(const uint64_t x, int n) -> uint64_t
{
    return (x << n) | (x >> (64 - n));
}
...
static auto mul64(__m256i acc, __m256i c_lo, __m256i c_hi) -> __m256i
{
...
static auto mix(__m256i acc, __m256i word, __m256i p1_lo, __m256i p1_hi, __m256i p2_lo, __m256i p2_hi) -> __m256i
{
    // acc ^= word * prime_1
